...
export const Element = (props) => {
  ...
  const thisDoc = doc(firestore, "files", props.item.id)
  ...
  return <div className='flex justify-between w-screen px-4 py-2 md:px-20 items-center'>
    ...
    <div>
      {edit ?
        ...
        <button onClick={change} className="inline-flex items-center justify-center w-10 h-10 mr-2 text-indigo-100 transition-colors duration-150 bg-sky-500 rounded-lg focus:shadow-outline hover:bg-sky-600">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <button onClick={deleteUser} className="inline-flex items-center justify-center w-10 h-10 mr-2 text-indigo-100 transition-colors duration-150 bg-red-500 rounded-lg focus:shadow-outline hover:bg-red-600">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
