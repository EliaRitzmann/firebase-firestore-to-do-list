...
export const Navbar = () => {
  ...
  //Date
  const d = new Date();
  const months = ["Januar", "Februar", "März", "April", "May", "Juni", "July", "August", "September", "Oktober", "November", "Dezember"];
  ...
  return <nav className=''>
    ...
    {/* Sidebar */}
    <div className={sidebar ? 'h-full w-9/12 sm:w-72 fixed top-0 rounded-r-xl shadow-black shadow-md backdrop-blur-3xl' : 'left-full fixed'}>
