...
export const Sidebar = () => {
  ...
  return <div className='flex flex-col items-center gap-2'>
    <button onClick={btn_home} className='inline-flex w-4/5 h-10 items-center justify-between rounded-lg px-2 bg-white shadow shadow-gray-400'>
    ...
    <button onClick={btn_all} className='inline-flex w-4/5 h-10 items-center justify-between rounded-lg px-2 bg-white shadow shadow-gray-400'>
      <div className='flex gap-2'>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <button onClick={btn_fav} className='inline-flex w-4/5 h-10 items-center justify-between rounded-lg px-2 bg-white shadow shadow-gray-400'>
      <div className='flex gap-2'>
